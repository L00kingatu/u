...
const messageText = `Dear Lovelle, 🌸

Selamat ulang tahun! ✨
Semoga di hari yang spesial ini, semua doa-doa baikmu dikabulkan.
Kamu adalah sosok yang sangat berharga, cantik, dan selalu membawa kehangatan & tawa di sekitarmu.
Tetaplah menjadi dirimu sendiri yang luar biasa. 💖

I will selalu ada di sini untuk mendukungmu dalam segala hal.
Nikmati kado kecil ini yang dibuat khusus untuk kamu! 🎂🤍`;
